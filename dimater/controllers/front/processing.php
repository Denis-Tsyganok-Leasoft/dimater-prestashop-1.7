...
class dimaterProcessingModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $this->context->smarty->assign(
            [
                'fallback_url' => $this->context->link->getModuleLink('dimater', 'pending'),
        ...
        $this->setTemplate('module:dimater/views/templates/front/processing.tpl');
    }
    ...
    public function checkOrderStatus()
    {
        $ginger = Ginger::createClient(
		  	...
		  	\Configuration::get('DIMATER_APIKEY'),
		  	(null !== \Configuration::get('DIMATER_BUNDLE_CA')) ?
			    [
